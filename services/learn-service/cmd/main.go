...
import (
	...
	_ "github.com/Sheliakhin-Golang-portfolio/JapaneseStudent/learn-service/docs"
	"github.com/Sheliakhin-Golang-portfolio/JapaneseStudent/learn-service/internal/handlers"
	"github.com/Sheliakhin-Golang-portfolio/JapaneseStudent/learn-service/internal/repositories"
	"github.com/Sheliakhin-Golang-portfolio/JapaneseStudent/learn-service/internal/services"
...
func main() {
	...
	logger.Logger.Info("Starting JapaneseStudent Service")
	...
	adminCharService := services.NewAdminService(repo, cfg.MediaBaseURL, cfg.APIKey)
	...
	r.Use(sharedMiddleware.RequestSizeLimitMiddleware(maxRequestSize)) // 10MB
...
func runMigrations(db *sql.DB) error {
	...
	driver, err := mysql.WithInstance(db, &mysql.Config{
		MigrationsTable: "learn_schema_migrations",
	})
	if err != nil {
	...
	if _, err := os.Stat("migrations"); os.IsNotExist(err) {
		// Try parent directory if running from cmd/japanese-student
